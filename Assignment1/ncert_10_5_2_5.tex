...
The $n^{th}$ term of the Arithmetic progression \brak{x\brak{n}} is given as x\brak{0} + nd.
...
\textbf{\brak{ii}} The $n^{th}$ term of the Arithmetic progression \brak{x\brak{n}} is given as x(0) + nd
...
\textbf{\brak{i}} The $n^{th}$ term of the Arithmetic progression is given as x(0) + \brak{n}d . x\brak{0} = 7 and d = 6.
...
\textbf{\brak{ii}} The $n^{th}$ term of the Arithmetic progression is given as x\brak{0} + nd. x\brak{0} = 18 and d = -2$\frac{1}{2}$
